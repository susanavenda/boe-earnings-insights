...
**Peer caveat:** Matched 2025-H1 has both banks, but one side is 100% FinBERT-neutral (HSBC net=-0.126, n=8, non-neut=25%; Barclays net=0.000, n=7, non-neut=0%). Gap -0.126 is not treated as an A2 alert.
...
**NULL — no early-warning edge from Q&A this quarter**

Credit Suisse 2022-q4 (FY): FinBERT net 0.08. Peer gap is HSBC−Barclays only; n/a for out-of-sample banks.
...
**Peer caveat:** Peer gap is HSBC−Barclays only; n/a for out-of-sample banks.
...
| A1 | alert | — | Topic 1 negative share rises vs prior print AND credit_impairment narrative disagrees with reported direction |
| A2 | alert | — | Matched peer gap (HSBC−Barclays) < −0.10 on H1/FY, both banks n≥3, and peer side not 100% FinBERT-neutral |
| A3 | watch | — | FinBERT net soft (< −0.08) but structured metrics agree with narrative |
| N1 | null | FIRED | Topics stable, FinBERT net ≈ flat, structured↔unstructured agree |
